...
define( 'WP_SEO_AUTOMATER_VERSION', '1.4.2' );
...
if ( ! function_exists( 'wp_seo_automater_activate' ) ) {
	function wp_seo_automater_activate() {
		...
		if ( false === get_option( 'wp_seo_automater_gemini_model' ) ) {
			add_option( 'wp_seo_automater_gemini_model', 'gemini-3.6-flash' );
		}
		if ( false === get_option( 'wp_seo_automater_image_alt_model' ) ) {
			add_option( 'wp_seo_automater_image_alt_model', 'gemini-3.6-flash' );
		}
