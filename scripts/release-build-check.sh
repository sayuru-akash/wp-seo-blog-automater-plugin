...
assert_zip_contains "$zip_index" "${PLUGIN_SLUG}/admin/js/media-alt-text.js"
assert_zip_contains "$zip_index" "${PLUGIN_SLUG}/admin/css/style.css"
assert_zip_contains "$zip_index" "${PLUGIN_SLUG}/admin/css/media-alt-text.css"
...
assert_zip_contains "$zip_index" "${PLUGIN_SLUG}/includes/class-wp-seo-automater-media-alt-text.php"
